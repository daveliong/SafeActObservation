...
function ShowMoreResults (ctx, controlId) {
	...
	if(showPaging)
	{
		...
		if(showPaging)
		{
			...
			if(hasPreviousPage)
			{
				hiddenElm.after('<a href="#" id="'+controlId+'showprevious" class="previousSearchResults">Show Previous Search Results</a>');
			}
					
			if(hasNextPage)
			{
				hiddenElm.after('<a href="#" id="'+controlId+'shownext" class="nextSearchResults">Show Next Search Results</a>');
			}
